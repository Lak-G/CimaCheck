...
namespace CimaCheck.Controllers
{
    ...
    {
        //public static async Task<bool> ActualizarAsistencia(Supabase.Client supabase, List<Alumno> lsAlumnos)
        //{
        //    try
        //    {
        //        if (supabase == null)
        ...
        //        var listaDb = lsAlumnos.Select(a => new AlumnoEscuelaDb
        //        {
        //            Id = a.Id,
        //            IdEscuela = a.IdEscuela,
        //            NombreCompleto = a.NombreAlumno,
        //            asistencia = a.Asistencia,
        //            VisitanteId = a.VisistanteId
        //        }).ToList();
